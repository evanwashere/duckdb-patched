...
DUCKDB_API void duckffi_disconnect(duckdb_connection con);
DUCKDB_API void duckffi_free_result(duckdb_result* result);
DUCKDB_API void duckffi_free_ltype(duckdb_logical_type ltype);
...
DUCKDB_API uint32_t duckffi_enum_size(duckdb_logical_type type);
DUCKDB_API uint32_t duckffi_enum_type(duckdb_logical_type type);
...
DUCKDB_API uint32_t duckffi_param_count(duckdb_prepared_statement prepare);
DUCKDB_API char* duckffi_enum_string(duckdb_logical_type type, uint32_t offset);
DUCKDB_API uint32_t duckffi_column_type(duckdb_result* result, uint32_t offset);
DUCKDB_API const char* duckffi_prepare_error(duckdb_prepared_statement prepare);
DUCKDB_API const char* duckffi_column_name(duckdb_result* result, uint32_t offset);
DUCKDB_API uint32_t duckffi_param_type(duckdb_prepared_statement prepare, uint32_t offset);
DUCKDB_API duckdb_logical_type duckffi_column_ltype(duckdb_result* result, uint32_t offset);

DUCKDB_API bool duckffi_bind_null(duckdb_prepared_statement prepare, uint32_t offset);
DUCKDB_API bool duckffi_bind_i8(duckdb_prepared_statement prepare, uint32_t offset, int8_t value);
DUCKDB_API bool duckffi_bind_f32(duckdb_prepared_statement prepare, uint32_t offset, float value);
DUCKDB_API bool duckffi_bind_u8(duckdb_prepared_statement prepare, uint32_t offset, uint8_t value);
DUCKDB_API bool duckffi_bind_f64(duckdb_prepared_statement prepare, uint32_t offset, double value);
DUCKDB_API bool duckffi_bind_i16(duckdb_prepared_statement prepare, uint32_t offset, int16_t value);
DUCKDB_API bool duckffi_bind_i32(duckdb_prepared_statement prepare, uint32_t offset, int32_t value);
DUCKDB_API bool duckffi_bind_i64(duckdb_prepared_statement prepare, uint32_t offset, int64_t value);
DUCKDB_API bool duckffi_bind_u16(duckdb_prepared_statement prepare, uint32_t offset, uint16_t value);
DUCKDB_API bool duckffi_bind_u32(duckdb_prepared_statement prepare, uint32_t offset, uint32_t value);
DUCKDB_API bool duckffi_bind_u64(duckdb_prepared_statement prepare, uint32_t offset, uint64_t value);
DUCKDB_API bool duckffi_bind_boolean(duckdb_prepared_statement prepare, uint32_t offset, bool value);
DUCKDB_API bool duckffi_bind_timestamp(duckdb_prepared_statement prepare, uint32_t offset, uint64_t value);
DUCKDB_API bool duckffi_bind_blob(duckdb_prepared_statement prepare, uint32_t offset, const void* value, uint32_t length);
DUCKDB_API bool duckffi_bind_string(duckdb_prepared_statement prepare, uint32_t offset, const char* value, uint32_t length);
DUCKDB_API bool duckffi_bind_interval(duckdb_prepared_statement prepare, uint32_t offset, uint32_t ms, uint32_t days, uint32_t months);

DUCKDB_API int8_t duckffi_value_i8(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API float duckffi_value_f32(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint8_t duckffi_value_u8(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API double duckffi_value_f64(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API int16_t duckffi_value_i16(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API int32_t duckffi_value_i32(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API int64_t duckffi_value_i64(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint16_t duckffi_value_u16(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_u32(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint64_t duckffi_value_u64(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API bool duckffi_value_boolean(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API bool duckffi_value_is_null(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API char* duckffi_value_string(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_date(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_time(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API duckdb_blob* duckffi_value_blob(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint64_t duckffi_value_timestamp_ms(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_interval_days(duckdb_result* result, uint32_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_interval_months(duckdb_result* result, uint32_t row, uint32_t column);

DUCKDB_API int8_t duckffi_value_i8_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API float duckffi_value_f32_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint8_t duckffi_value_u8_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API double duckffi_value_f64_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API int16_t duckffi_value_i16_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API int32_t duckffi_value_i32_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API int64_t duckffi_value_i64_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint16_t duckffi_value_u16_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_u32_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint64_t duckffi_value_u64_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API bool duckffi_value_boolean_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API bool duckffi_value_is_null_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API char* duckffi_value_string_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_date_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API uint32_t duckffi_value_time_slow(duckdb_result* result, uint64_t row, uint32_t column);
DUCKDB_API duckdb_blob* duckffi_value_blob_slow(duckdb_result* result, uint64_t row, uint32_t column);
